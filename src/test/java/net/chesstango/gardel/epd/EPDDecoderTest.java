...
public class EPDDecoderTest {
    ...
    public void testReadEDP01() {
        ...
        assertEquals("1B1bk1nr/5pp1/rNR5/p3Pp1p/1p2pP2/1P5P/1PP3P1/2KR4 w k -", epd.getFenWithoutClocks());
    ...
    public void testReadEDP02() {
        ...
        assertEquals("r3k3/8/2P1b3/p3p1P1/P6B/1pKBR1R1/1P3b2/3r1N2 b q -", epd.getFenWithoutClocks());
    ...
    public void testReadEDP03() {
        ...
        assertEquals("8/6R1/1p6/p2r2pk/3P1R2/6P1/q4P2/2B2K2 w - -", epd.getFenWithoutClocks());
    ...
    public void testReadEDP04() {
        ...
        assertEquals("q1r3r1/1b3Nbk/p3QBpp/1p1P3P/B1n5/8/P4PP1/3RR1K1 w - -", epd.getFenWithoutClocks());
    ...
    public void testReadEDP05() {
        ...
        assertEquals("8/kpP2r1p/p6r/n3Q1p1/P6q/1PN3p1/5P2/2RR2K1 w - -", epd.getFenWithoutClocks());
    ...
    public void testReadEDP06() {
        ...
        assertEquals("r1bq2rk/pp3pbp/2p1p1pQ/7P/3P4/2PB1N2/PP3PPR/2KR4 w - -", epd.getFenWithoutClocks());
    ...
    public void testReadEDP07() {
        ...
        assertEquals("1n2rr2/1pk3pp/pNn2p2/2N1p3/8/6P1/PP2PPKP/2RR4 w - -", epd.getFenWithoutClocks());
    ...
    public void testReadEDP08() {
        ...
        assertEquals("rb3qk1/pQ3ppp/4p3/3P4/8/1P3N2/1P3PPP/3R2K1 w - -", epd.getFenWithoutClocks());
    ...
    public void testReadSM() {
        ...
        assertEquals("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq -", epd.getFenWithoutClocks());
