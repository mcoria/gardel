...
public class LANDecoderTest {
    ...
    public void testDecodeLAN01_Promotion() {
        FEN fen = FEN.from("8/kpP2r1p/p6r/n3Q1p1/P6q/1PN3p1/5P2/2RR2K1 w - - 0 1");
    ...
    public void testDecodeMovePawn() {
        FEN fen = FEN.from("1Q4rr/1p1bkp2/pP6/2p1pP2/3nP1Bp/2P1q2P/7K/3R1R2 w - - 0 1");
    ...
    public void testDecodeMoveRook() {
        FEN fen = FEN.from("6k1/p1pp2pp/2p5/8/3P3q/3bP3/PP3rPP/R1K1Q2R b - - 0 1");
