...
public class SANDecoderTest {
    ...
    public void testBishop() {
        FEN fen = FEN.from("rnbqk2r/pp1p1ppp/4pn2/2p5/1bPP4/2N1P3/PP3PPP/R1BQKBNR w KQkq c6 0 5");
    ...
    public void testRookCapture() {
        FEN fen = FEN.from("r1b1Rbkr/pp4pp/2p3n1/3p2BB/8/2N2R2/PPP2PPP/2K5 w - - 0 1");
    ...
    public void testPawnMovePromotion02() {
        FEN fen = FEN.from("8/PR1nk2p/4p1p1/8/3p3P/5K2/8/8 w - - 9 54");
    ...
    public void testPawnMovePromotion03() {
        FEN fen = FEN.from("2k1r3/1p1b4/p1p5/P1P5/1P1P1p2/3B1K2/6pP/3R4 b - - 0 37");
    ...
    public void testCheck01() {
        FEN fen = FEN.from("6k1/5p2/p6p/1pQ3P1/2n1B3/2P1PpP1/q4r2/4R1K1 b - - 0 37");
    ...
    public void testCheck02() {
        FEN fen = FEN.from("r1bq1rk1/ppp2ppp/3p1n2/3Np3/1bPnP3/5NP1/PP1P1PBP/R1BQ1RK1 b - - 3 8");
